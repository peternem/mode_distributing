  ...
  <article id="mainContent">
    <section class="indexbox1">
     ...
     <ul class="linkList right">
      ...
      <div class="moreInfoDiv"> <a href="products.php"><span>Learn More</span><img src="images/icons/learnMoreArrow.png" alt="&raquo;" /></a></div>
    </section>
    <section class="indexbox2">
      <div class="subBox clearfix">
        <a href="new_products.php"><h3>New Products</h3></a>
        <a title="New Mode Products" href="new_products.php" class="imageLink rollButton"><img src="images/rollover/newproduct-btn.png" alt="New Products" class="imageCenterBox" /></a> </div>
      <div class="subBox">
    ...
    <section class="indexbox3 clearfix">
     <a href="services.php"><h3>Services</h3></a>
      ...
      <!-- <ul class="linkList right">
        <li><a href="#">conse ctetur xxc</a></li>
        <li><a href="#">adipiscing</a></li>
        <li><a href="#">elit</a></li>
        <li><a href="#">AGA</a></li>
      </ul>-->
      <div class="moreInfoDiv"> <a href="services.php"><span>Learn More</span><img src="images/icons/learnMoreArrow.png" alt="&raquo;"/></a></div>
    </section>
  </article>
</div>
<footer>
