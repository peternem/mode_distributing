	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				<section class="span4">
					<header>
						<a href="products.php" title="Products"><h2>Products</h2></a
					</header>
					<a title="Visit Products" href="products.php" class="imageLink rollButton"><img src="../../images/rollover/product-btn.png" alt="" class="imageTabBox1" /></a>
					<h3>Luxurious Home Appliances to meet the needs of your home.</h3>
					...
					<footer>
						<a href="products.php" class="btn btn-mini ">Learn More <i class="icon-chevron-right icon-black"></i></a>
					</footer>
				</section>
				<section class="span4">
					<h2>Heading</h2>
